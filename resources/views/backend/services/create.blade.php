                        ...
                        <form action="{{ route('admin.services.store') }}"
                            ...
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 form-group">
                                        <textarea id="summernote" class="form-control rich-text" name="description" rows="5">{{ old('description') }}</textarea>
                                    ...
                                    <div class="col-sm-12 d-flex justify-content-end">
                                        <button type="submit" class="btn btn-primary me-1 mb-1">Create Service</button>
